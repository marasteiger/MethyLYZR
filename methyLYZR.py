...
if __name__ == "__main__":
    ...
    parser.add_argument("-c", "--centroids", type=str, default="model/betas_mean.feather", required=True, help="Filepath to the pre-trained class centroids")
    parser.add_argument("-w", "--weights", type=str, default="model/W_RELIEF.feather", required=True, help="Filepath to the pre-trained weights")
    parser.add_argument("-p", "--priors", type=str, default="model/class_priors.csv", required=True, help="Filepath to the pre-trained class priors")
